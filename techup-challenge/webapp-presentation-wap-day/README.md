...
* 20 mins before your scheduled slot, please head to Room #03-02 at ASCCE.&#x20;
* One-by-one, you will be asked to individually present your app before a group of seasoned PM and UX Design practitioners, who will serve as your evaluators. Each individual presenter gets 15 mins, which comprises:
  * 10-mins presentation
  * 5-mins Q\&A, in which the evaluators would ask probing questions and share their feedback.

## What should I need to present?

During the allocated 5 mins of presentation time, you should focus on covering the following:

1. **State your problem statement and chosen metrics**
   * Ensure that your problem statement should contain a clear and sound description of your (i) target users, (ii) pain-points, and (iii) consequences (if the problem is not addressed)
   * Ensure that you have selected the right metrics.&#x20;
...
Presentation slides are not mandatory, but can serve as a helpful guide for the evaluators to grasp the gist of your presentation.&#x20;
...
1. Whether you have successfully identified the right metrics to measure success.&#x20;
